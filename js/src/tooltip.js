...
class Tooltip extends BaseComponent {
  ...
  getTitle() {
    let title = this._element.getAttribute('data-original-title')
  ...
  _fixTitle() {
    const titleType = typeof this._element.getAttribute('data-original-title')

    if (this._element.getAttribute('title') || titleType !== 'string') {
